...
- Name: smoke.spec.js >> Smart Lost & Found - Web App Smoke Suite >> 5. Socket.IO polling endpoint does not return SPA index.html
- Location: e2e\smoke.spec.js:47:3
...
Call log:
  - → GET http://127.0.0.1:3000/socket.io/?EIO=4&transport=polling
