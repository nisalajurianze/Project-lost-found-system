  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[90px] right-4 sm:bottom-6 sm:right-6 p-3 sm:p-4 rounded-full bg-primary-600 text-white shadow-xl hover:bg-primary-700 transition-transform duration-300 z-50 ${isOpen ? 'scale-0' : 'scale-100 hover:scale-110'}`}
