...
| 9 | Voice input | `provider-dependent` | `frontend/src/components/common/AIChatbot.jsx` | Browser speech-recognition UAT |
...
| 12 | Confidence calibration | `implemented` | `backend/services/matchScoringService.js` | `backend/tests/ai-matching.test.js` |
...
| 16 | Image moderation | `provider-dependent` | `backend/services/imageAnalysisService.js` | Live provider moderation tests pending |
...
| 18 | Category/icon intelligence | `provider-dependent` | `backend/services/imageAnalysisService.js`; `category auto-create workflow` | Provider and admin workflow UAT |
...
| 20 | Missing-information assistance | `implemented` | `backend/services/reportQualityService.js`; `claim questions` | `backend/tests/report-intelligence.test.js` |
...
| 22 | Admin AI triage | `implemented` | `backend/controllers/adminController.js`; `admin dashboards/queues` | `backend/tests/dashboard-source.test.js` |
...
| 26 | Smart notifications | `implemented` | `backend/services/notificationService.js`; `backend/services/emailService.js` | Live email/push delivery pending |
| 27 | Feedback-based improvement | `implemented` | `backend/models/AIDecisionFeedback.js`; `admin review UI` | `backend/tests/report-intelligence.test.js`; `frontend/tests/ai-governance.test.mjs` |
...
| 29 | AI monitoring | `implemented` | `backend/services/aiProviderService.js`; `admin AI health UI` | `backend/tests/ai-provider.test.js` |
| 30 | AI governance/safety controls | `implemented` | `serializers, risk/feedback policies, provider schema validation` | security and focused AI tests |
| 31 | SEUSL regional micro-location intelligence | `field-data-dependent` | `backend/data/seuslLocations.js`; `LocationKnowledge governance` | `backend/tests/location-governance.test.js`; field/university approval pending |
